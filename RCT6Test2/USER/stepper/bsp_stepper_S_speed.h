...
#define CW    LOW             //顺时针         2025年3月28日10:08:53  崔凯电路板，电机驱动板方向反转
#define CCW  HIGH                //逆时针


//控制使能引脚
#define MOTOR_DIR_PIN GPIO_PIN_5  //方向
#define MOTOR_DIR_GPIO_PORT GPIOB

#define MOTOR_EN_PIN GPIO_PIN_11    //使能
#define MOTOR_EN_GPIO_PORT GPIOC

#define MOTOR_PUL_PIN GPIO_PIN_8    //脉冲
...
#define MICRO_STEP        		32          				             //细分器细分数   原来是32细分。
